...
Begin VB.Form frm_browse_obat 
   ...
   Begin MSDBGrid.DBGrid Grid 
      Bindings        =   "frm_browse_obat.frx":0000
      Height          =   4095
      Left            =   120
      OleObjectBlob   =   "frm_browse_obat.frx":0014
      TabIndex        =   0
      Top             =   120
      Width           =   8415
   End
...
'Text2.Text = Grid.Columns(5).Text
'If Grid.Columns(5).Text <= Text1.Text Then
...
frm_resep.Text5.Text = Grid.Columns(5).Text
